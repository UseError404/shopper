(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                document.querySelector(".menu__body").classList.toggle("show-menu");
            }
        });
    }
    function formRating() {
    ...
    function initSliders() {
        if (document.querySelector(".sellers__swiper")) new swiper_core_Swiper(".sellers__swiper", {
        ...
        if (document.querySelector(".trend__swiper")) new swiper_core_Swiper(".trend__swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".launch__slider")) new swiper_core_Swiper(".launch__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        colorButtons.forEach(button => {
            button.addEventListener("click", function() {
                ...
                imageContainers.forEach(container => {
                    ...
                    if (container.dataset.color === color) container.classList.add("launch__slide-container-images-active");
                });
            });
        });
        ...
        function checkWindowsSize() {
            if (window.innerWidth < breakpoint) activeImageLaunch();
        }
        checkWindowsSize();
